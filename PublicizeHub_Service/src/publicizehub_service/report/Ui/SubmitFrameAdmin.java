...
public class SubmitFrameAdmin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "select id, projectNameThai, department, type, endTime from project INNER JOIN place ON project.placeId = place.placeId where status = 3"+name+department+type+endTime+" ORDER BY id";
